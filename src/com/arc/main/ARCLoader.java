...
class ARCLoader extends JFrame {
    private static final String VERSION_STR = "1.0 beta";
        ...
        try {
            ...
            mJButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent arg0) {
                    ...
                    if (mSPath == null && mSPath.length() <= 0) {
                        JOptionPane.showMessageDialog(ARCLoader.this, "选择目录", "Error",
            ...
            setSize(400, 300);
            {
                        ...
                        mOpenFileMenuItem.addActionListener(new ActionListener() {
                            ...
                            public void actionPerformed(ActionEvent e) {
                                if (e.getActionCommand().equals("打开")) {
                                    ...
                                    int returnVal = jFileChooser.showOpenDialog(ARCLoader.this);
                                    if (returnVal == JFileChooser.APPROVE_OPTION) {
                                        mSPath = jFileChooser.getSelectedFile().getAbsolutePath();
                                        mCleanRes = new Processor(mSPath);
                                        mUnusedResList.setListData(new String[] {
                                                "工程目录: "+mSPath
                                        });
                ...
                mHelpMenuItem.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent arg0) {
                        JOptionPane.showMessageDialog(ARCLoader.this, "Version v" + VERSION_STR, "ARC",
